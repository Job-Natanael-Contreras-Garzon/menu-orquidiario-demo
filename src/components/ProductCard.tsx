        ...
        <div className="flex flex-col flex-grow p-4 sm:pl-0 sm:w-2/3">
          <CardHeader className="p-0">
            <div className="flex justify-between items-start">
              <CardTitle className="font-headline text-2xl">{t(item.name)}</CardTitle>
             ...
             <CardDescription className="text-xs uppercase tracking-wider text-muted-foreground pt-1">{t(`menuPage.subCategories.${item.subCategory}`)}</CardDescription>
          </CardHeader>
